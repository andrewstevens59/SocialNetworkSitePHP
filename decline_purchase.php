...
$query = "insert into alert_updates values (" . $_SESSION['home_user'] . "," .  $_REQUEST['user'] . ", -1, '<b><a href=\'show_product.php?id=" . $_REQUEST['id'] . "\'> " . $row['name'] . "</a></b> not available for purchase at this time', now())";
$result = mysql_query($query);
